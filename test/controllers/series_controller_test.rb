...
class SeriesControllerTest < ActionController::TestCase
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post :create, series: { author: @series.author, description: @series.description, image: @series.image, name: @series.name }
    end
  ...
  test "should update series" do
    patch :update, id: @series, series: { author: @series.author, description: @series.description, image: @series.image, name: @series.name }
    assert_redirected_to series_path(assigns(:series))
  end
